 ...
 * https://modernizr.com/download/?-canvas-csspointerevents-setclasses !*/
! function(e, n, t) {
    function s(e, n) {
        return typeof e === n
    }
    ...
    function a() {
        ...
        for (var f in l)
            if (l.hasOwnProperty(f)) {
                ...
                for (a = s(n.fn, "function") ? n.fn() : n.fn, o = 0; o < e.length; o++) i = e[o], c = i.split("."), 1 === c.length ? Modernizr[c[0]] = a : (!Modernizr[c[0]] || Modernizr[c[0]] instanceof Boolean || (Modernizr[c[0]] = new Boolean(Modernizr[c[0]])), Modernizr[c[0]][c[1]] = a), r.push((a ? "" : "no-") + c.join("-"))
            }
    }
    ...
    }), a(), o(r), delete c.addTest, delete c.addAsyncTest;
